...
namespace SistemaVenta.API.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        {
            var rsp = new Response<SesionDTO>();//objeto de respuesta

            try
            {
                rsp.status = true;
                rsp.value = await _usuarioServicio.ValidarCredenciales(login.Correo,login.Clave);//modificamos la respuesta
